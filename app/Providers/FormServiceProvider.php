...
class FormServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Form::component('textGroup', 'partials.form.text_group', [
            'name', 'text', 'icon', 'attributes' => ['required' => 'required'], 'value' => null, 'col' => 'col-md-2',
        ]);
        ...
        Form::component('selectGroup', 'partials.form.select_group', [
            'name', 'text', 'icon', 'values', 'selected' => null, 'attributes' => ['required' => 'required'], 'col' => 'col-md-2',
        ]);
        ...
        Form::component('radioGroup', 'partials.form.radio_group', [
            'name', 'text', 'enable' => trans('general.yes'), 'disable' => trans('general.no'), 'attributes' => [], 'col' => 'col-md-2',
        ]);
        ...
        Form::component('fileGroup', 'partials.form.file_group', [
            'name', 'text', 'attributes' => [], 'value' => null, 'col' => 'col-md-2',
        ]);
